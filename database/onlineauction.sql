...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2022 at 03:08 AM
...
(1, 'REALME 8 Pro 8GB - 128GB', 8000000, 10000000, 500000, 7900000, NULL, '2021-12-12 23:23:11', '2022-01-14 10:10:00', 0, '<p>Thương hiệu: Realme</p> <p>Xuất xứ: Trung Quốc</p> <p>Thời gian bảo h&agrave;nh: 12 Th&aacute;ng</p> <p>M&agrave;n h&igrave;nh: 6.4&quot;, FHD+, Super AMOLED, 1080 x 2400 Pixel</p> <p>Camera sau: 108.0 MP + 8.0 MP + 2.0 MP + 2.0 MP</p> <p>Camera trước: 16.0 MP</p> <p>CPU: 2 x Kryo 465 2.3 GHz + 6 x Kryo 465 1.8 GHz</p> <p>RAM: 8GB</p> <p>Bộ nhớ trong: 128GB</p>', 1, 'dhuy01', 0, 1, 1),
...
(33, 'ALEXANDER MCQUEEN Selvedge Polo', 5000000, 10049600, 1000000, 5000000, 'renren', '2021-12-11 11:16:11', '2022-01-14 10:15:00', 1, '<p>&Aacute;o sơ mi polo b&ocirc;ng đen với chi tiết xếp placket của Alexander McQueen Selvedge.<br /> Chất liệu: 100% cotton</p>', 3, 'nbtram', 1, 1, 1),
...
(45, 'THOM BROWNE Grey Camera Bag', 9000000, 17472600, 1300000, 9000000, NULL, '2022-01-23 23:00:00', '2022-01-14 10:00:00', 0, '<p>T&uacute;i m&aacute;y ảnh nhỏ bằng len Melton hai mặt m&agrave;u x&aacute;m trung b&igrave;nh với d&acirc;y đeo bằng vải sọc v&agrave; chi tiết 4 vạch ton-sur-ton. Đ&oacute;ng zip k&eacute;o, t&uacute;i zip ph&iacute;a trước, bảng t&ecirc;n ở mặt. C&aacute;c chi tiết da dạng hạt sỏi. Tab v&ograve;ng lặp grosgrain sọc đặc trưng ở mặt.<br /> 93% len, 5% Casmhere, 2% da b&ecirc;.</p> <p>Sản xuất tại &Yacute;</p>', 5, 'nbtram', 0, 0, 1),
...
('TyZ04vJbcYUvManmWFHJqRszmGrl3_-9', 1642212431, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"auth\":false}'),
